...
//-------------------------Constants-----------------------------------------
	...
	// File Path Constants
	static final String ADMIN_FILE_PATH = "" + Paths.get(System.getProperty("user.dir"), "JavaBankingSystem" + File.separator + "admin_data.txt").toAbsolutePath();
	static final String CUSTOMER_FILE_PATH = "" + Paths.get(System.getProperty("user.dir"), "JavaBankingSystem" + File.separator + "customer_data.txt").toAbsolutePath();
	static final String TEMP_FILE_PATH = "" + Paths.get(System.getProperty("user.dir"), "JavaBankingSystem" + File.separator + "temp_file.txt").toAbsolutePath();
